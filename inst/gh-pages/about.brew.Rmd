...
This website will serve as a communication platform as we work so that we can share the process as well as final results. Our code is available [here](https://github.com/OHI-Science/<%=study_area%>).
