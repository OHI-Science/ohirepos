...
## Assessing ocean health in <%=study_area%>
 
We are building a scientifically robust assessment of ocean health for <%=study_area%>. The OHI framework facilitates transparent and repeatable assessments of ocean health over time, and can be integrated into ongoing policy initiatives to support sustainable ocean management. We will build from previous OHI assessments and tailor the OHI framework to represent the cultural, social, and ecological characteristics and priorities of <%=study_area%> using the best available information and knowledge.
...
Learn more at [ohi-science.org](http://ohi-science.org) and read our publications about [best practices for assessing ocean health](https://peerj.com/articles/1503/) and [how OHI assessments are transparent and repeatable](https://www.nature.com/articles/s41559-017-0160).
